create table cart4j_auth.c4_access_token
(
...
create table cart4j_auth.c4_client
(
  id bigint auto_increment
    primary key,
...
create table cart4j_auth.c4_client_access_token
(
  ...
  constraint c4_client_access_token_c4_client_id_fk
    foreign key (client_id) references cart4j_auth.c4_client (id)
      on update cascade on delete cascade,
  constraint c4_client_access_token_c4_access_token_id_fk
    foreign key (access_token_id) references cart4j_auth.c4_access_token (id)
      on update cascade on delete cascade
)
  engine=InnoDB
;
...
on cart4j_auth.c4_client_access_token (access_token_id)
;

create table cart4j_auth.c4_client_role
(
  client_id bigint not null,
...
(
  ...
  constraint c4_client_redirect_uri_c4_redirect_uri_id_fk
    foreign key (redirect_uri_id) references cart4j_auth.c4_redirect_uri (id)
      on update cascade on delete cascade
)
  engine=InnoDB collate=utf8_unicode_ci
;
...
on cart4j_auth.c4_client_redirect_uri (redirect_uri_id)
;

create table cart4j_auth.c4_refresh_token
(
  id bigint auto_increment
    primary key,
...
create table cart4j_auth.c4_resource
(
  id bigint auto_increment
    primary key,
...
create table cart4j_auth.c4_client_resource
(
  client_id bigint not null,
  ...
  constraint c4_client_resource_c4_resource_id_fk
    foreign key (resource_id) references cart4j_auth.c4_resource (id)
      on update cascade on delete cascade
)
  engine=InnoDB collate=utf8_unicode_ci
;
...
on cart4j_auth.c4_client_resource (resource_id)
;

create table cart4j_auth.c4_role
(
  id bigint auto_increment
    primary key,
...
create table cart4j_auth.c4_scope
(
  id bigint auto_increment
    primary key,
...
create table cart4j_auth.c4_client_scope
(
  client_id bigint not null,
  ...
  constraint c4_client_scope_c4_scope_id_fk
    foreign key (scope_id) references cart4j_auth.c4_scope (id)
      on update cascade on delete cascade
)
  engine=InnoDB collate=utf8_unicode_ci
;
...
on cart4j_auth.c4_client_scope (scope_id)
;

create table cart4j_auth.c4_user
(
  id bigint auto_increment
    primary key,
...
create table cart4j_auth.c4_user_access_token
(
  access_token_id bigint not null,
  ...
  constraint c4_user_access_token_c4_user_id_fk
    foreign key (user_id) references cart4j_auth.c4_user (id)
      on update cascade on delete cascade
)
  engine=InnoDB collate=utf8_unicode_ci
;
...
on cart4j_auth.c4_user_access_token (user_id)
;

create table cart4j_auth.c4_user_role
(
  user_id bigint not null,
  role_id bigint not null,
  constraint user_id
...
on cart4j_auth.c4_user_role (role_id)
;
